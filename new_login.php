  ...
  <div class="row justify-content-center">
    <div class="col-lg-10 col-xl-9">
      ...
      <div class="text-center mb-4">
        ...
        <h1 class="fw-bold">ISPSC CLINICA Portal</h1>
        <p class="text-muted">Login or Register as Student / Employee</p>
      </div>
      ...
      <div class="card shadow-sm p-4">
        ...
        <ul class="nav nav-pills justify-content-center mb-4 flex-wrap" id="mainTabs">
          ...
          <li class="nav-item mb-2">
            <button class="nav-link" id="register-tab" data-bs-toggle="tab" data-bs-target="#register-forms">Register</button>
          </li>
        </ul>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="login-form">
            ...
            <ul class="nav nav-tabs mb-3" id="registerTabs">
              <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#student-login">Student</button>
              </li>
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#employee-login">Employee</button>
              </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="student-login">
                    <form method="POST" id="studentLoginForm">
                        ...
                        <div class="input-group">
                            <input type="password" id="student_login_password" name="password" class="form-control" placeholder="Enter your password" required>
                            <button class="btn btn-outline-secondary" type="button" id="toggleStudentLoginPassword">
                            <i class="bi bi-eye"></i>
                            </button>
                        </div>
                        </div>
                ...
                <!-- EMPLOYEE LOGIN -->
                <div class="tab-pane fade" id="employee-login">
                    ...
                    <form method="POST" id="employeeLoginForm">
                            ...
                            <label for="login_password" class="form-label">Password</label>
                            <div class="input-group">
                                <input type="password" id="employee_login_password" name="password" class="form-control" placeholder="Enter your password" required>
                                <button class="btn btn-outline-secondary" type="button" id="toggleEmployeeLoginPassword">
                                <i class="bi bi-eye"></i>
                                </button>
                            </div>
                            </div>
          ...
          <!-- REGISTER FORM -->
          <div class="tab-pane fade" id="register-forms">
            
            <!-- Sub-tabs -->
            <ul class="nav nav-tabs mb-3" id="registerTabs">
              <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#student-register">Student</button>
              </li>
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#employee-register">Employee</button>
              </li>
            </ul>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="student-register">
                <form method="POST" id="StudentRegisterForm">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" id="student_register_password" name="register_password" required>
                            <button class="btn btn-outline-secondary" type="button" id="toggleStudentRegisterPassword">
                            <i class="bi bi-eye"></i>
                            </button>
                        </div>
                        </div>
              ...
              <!-- EMPLOYEE REGISTER -->
              <div class="tab-pane fade" id="employee-register">
                <form method="POST" id="EmployeeRegisterForm">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label">Password</label>
                            <div class="input-group">
                                <input type="password" class="form-control" id="employee_register_password" name="register_password" required>
                                <button class="btn btn-outline-secondary" type="button" id="toggleEmployeeRegisterPassword">
                                <i class="bi bi-eye"></i>
                                </button>
                            </div>
                            </div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
     ...
     setupPasswordToggle("#toggleStudentLoginPassword", "#student_login_password");
    setupPasswordToggle("#toggleEmployeeLoginPassword", "#employee_login_password");
    setupPasswordToggle("#toggleStudentRegisterPassword", "#student_register_password");
    setupPasswordToggle("#toggleEmployeeRegisterPassword", "#employee_register_password");
