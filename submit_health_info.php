...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ✅ Check if health info already exists for this student
    $check = $conn->prepare("SELECT id FROM student_health_info WHERE student_id = ?");
    $check->bind_param("s", $valid_student_id);
    $check->execute();
    $check->store_result();
